...
class akarsh_blog_dashboard {
	...
	public function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'akarsh_blog_enqueue_scripts' ) );
	}
	 ...
	 * Show dashboard page.
	 */
	public function akarsh_blog_render() {
		?>
	 ...
	 */
	public function akarsh_blog_enqueue_scripts( $hook ) {
